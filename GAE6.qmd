...
This result is further defined by the contrast of uninfected versus infected pea aphids (@tbl-Planned and @tbl-Tukey).
...
These results show a significant difference between the Control and Infected groups, as well as a significant difference between the Uninfected and Infected groups. There was no significant difference between the Control and Uninfected groups. This supports the hypothesis that infection may lead to color change in pea aphids.
